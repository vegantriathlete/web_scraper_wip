 ...
 * @file
 *
 * Contains \Drupal\Tests\web_scrapter\Unit\DataValidationServiceTest
 */

namespace Drupal\Tests\web_scraper\Unit;

use Drupal\web_scrapter\ScrapedContentDataValidationService;
use Drupal\Tests\UnitTestCase;

/**
 * Tests methods in the Data Validation Service
 *
 * @coversDefaultClass \Drupal\web_scraper\ScrapedContentDataValidationService
 * @group web_scraper
 */
class DataValidationServiceTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\web_scraper\ScrapedContentDataValidationService
   */
  ...
  protected function setUp() {
    $this->dataValidationService = new ScrapedContentDataValidationService();
  }
   ...
   */
  public function testHasRequiredFieldsReturnsFalseWhenMissingRequiredFields($data) {
   ...
   */
  public function testHasRequiredFieldsReturnsTrueWhenAllRequiredFieldsArePresent($data) {
