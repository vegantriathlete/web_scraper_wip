 ...
 **                                                                          **
 ******************************************************************************/
$rest_uri = 'http://' . $domain . '/web_scraper/item?_format=' . $format;
 ...
 ******************************************************************************/
$post_fields = array(
  'headline' => 'My POSTed article translation - ' . $timestamp,
  'article_id' => $_GET['article_id'],
  'editor' => 1,
  'article_body' => '<p>I am not really going to pass a translation.</p>'
);
if (isset($_GET['language'])) {
  $post_fields['language_code'] = $_GET['language'];
  $post_fields['headline'] .= ' - language ' . $_GET['language'];
  $post_fields['article_body'] .= '<p>And I am not really using language ' . $_GET['language'] . '.</p>';
}
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <title>"POST"ing a translation for an article</title>
  </head>
  <body>
